  ...
  return (
    <>
      <Head>
        {/* Title */}
        <title>
          Codeware IT Dehradun | Web Development, MERN, ReactJS, Python, Java,
          PHP Internship
        </title>
        ...
        <meta
          property="og:title"
          content="Codeware IT Dehradun | Web Development Internship"
        />
        <meta
          property="og:description"
          content="Upskill in Web Development, MERN Stack, ReactJS, Python, Java, and PHP with Codeware IT Dehradun internship program. Get real-world project experience and certification."
        />
        <meta property="og:url" content="https://www.codewareit.in/intern" />
        <meta property="og:type" content="website" />
        <meta
          property="og:image"
          content="https://www.codewareit.in/codeware-logo.png"
        />
